...
const async_utils_1 = __importDefault(require("./utils/async.utils"));
...
function multipartUploadToPixelBin(url, fields, file, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const uploadChunk = (url, fields, chunk, partNumber, maxRetries) => __awaiter(this, void 0, void 0, function* () {
            ...
            while (retries < maxRetries) {
                try {
                    ...
                    res = yield http_utils_1.default.makeRequest(chunk.url, {
                        method: "PUT",
                        body: chunk.form,
                    });
                    if (!res.ok) {
        ...
        const completeMultipartUpload = (url, fields) => __awaiter(this, void 0, void 0, function* () {
            const urlObj = new URL(url);
            const res = yield http_utils_1.default.makeRequest(urlObj.toString(), {
                method: "POST",
                headers: {
        ...
        yield async_utils_1.default.mapLimit(fileChunks, concurrency, (chunk) => __awaiter(this, void 0, void 0, function* () {
            return yield uploadChunk(url, fields, chunk.chunk, chunk.partNumber, maxRetries);
        }));
        yield completeMultipartUpload(url, fields);
        return;
    });
}
/**
