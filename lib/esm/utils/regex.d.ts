...
export namespace pixelbinDomainRegex {
    const urlWithZone: RegExp;
    const urlWithoutZone: RegExp;
    const urlWithWorkerAndZone: RegExp;
...
export namespace customDomainRegex {
    ...
    export { urlWithWorker_1 as urlWithWorker };
}
